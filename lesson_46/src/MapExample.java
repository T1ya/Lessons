...
//        System.out.println();
        ...
        //как работает put
        System.out.println(map.put(11,"orange")); //если ключа нет - добавляется значение по ключу
        System.out.println(map.put(11,"magenta")); //а если есть - значение будет переписано
        System.out.println("map: " + map);
        //как работает replace
        //replace(K key, V value) заменяет значение пары по ключу
        System.out.println(map.replace(111,"red")); //- если ключа нет, пара не создаётся
        System.out.println(map.replace(15,"red"));  //- если есть, переписывает значение
        System.out.println("map: " + map);

        System.out.println("========== foreach ==========");
        //foreach()  - перебирает все пары ключ-значение с возможностью применить какую либо функцию
